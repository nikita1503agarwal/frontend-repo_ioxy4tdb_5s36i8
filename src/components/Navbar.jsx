  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
      <div className="mx-auto max-w-7xl px-6 py-4">
        <div className="flex items-center justify-between rounded-2xl border border-white/10 bg-[#0A0A0A]/60 backdrop-blur-xl px-5 py-3">
          <div className="flex items-center gap-3">
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute inset-0 blur-md rounded-lg bg-gradient-to-tr from-[#36FF8F] to-[#3DF2FF] opacity-40" />
              <div className="relative grid h-10 w-10 place-items-center rounded-lg bg-black border border-white/10">
                <Sparkles className="h-5 w-5 text-[#36FF8F]" />
              </div>
            </motion.div>
          ...
          <div className="hidden md:flex items-center gap-6 text-sm">
            ...
            <a href="#pricing" className="relative inline-flex items-center justify-center rounded-lg px-4 py-2 font-medium text-black">
              ...
              <span className="relative rounded-lg bg-gradient-to-r from-[#36FF8F] to-[#3DF2FF] px-4 py-2">Get started</span>
            </a>
          </div>
