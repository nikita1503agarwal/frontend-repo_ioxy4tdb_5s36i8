...
const quotes = [
  { name: 'Ava M.', role: 'Designer & Runner', text: 'I save 5+ hours a week and my macros are finally dialed. The calm UI helps me focus.' },
  { name: 'Jordan P.', role: 'Engineer', text: 'The AI swaps based on my cravings. Plans are balanced and grocery runs are shorter.' },
  { name: 'Kai R.', role: 'Creator', text: 'Clean, fast, minimal. It actually learns my taste and keeps variety high.' },
]

export default function Testimonials() {
  return (
    <section id="testimonials" className="relative py-28 bg-[var(--bg)]">
